...
public class SensorActivityBackup extends AppCompatActivity {
    ...
    private ScanCallback scanCallback = new ScanCallback() {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            Toast.makeText(SensorActivityBackup.this, "Founded: "+result.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= 23) {
                    if (checkSelfPermission(Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(SensorActivityBackup.this);
    ...
    public void onRequestPermissionsResult(int requestCode,@NonNull String[] permissions,
        ...
        if (requestCode == REQUEST_CODE) {
            if (grantResults.length > 0
                ...
                Toast.makeText(SensorActivityBackup.this, "Permission Granted!", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(SensorActivityBackup.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
            }
        }
